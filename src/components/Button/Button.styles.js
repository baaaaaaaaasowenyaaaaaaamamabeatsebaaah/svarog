...
export const buttonStyles = css`
  .btn {
    ...
    /* Base styles from theme variables */
  ...
  .btn:hover:not(:disabled) {
    ...
    transform: translateY(var(--button-hover-transform));
  }
  ...
  /* Additional variants that can be defined in themes */
  .btn--success {
  ...
  .btn:focus-visible {
    outline: 2px solid var(--button-focus-outline-color, currentColor);
    outline-offset: 2px;
  }
